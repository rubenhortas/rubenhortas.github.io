...
In my free time I like to play around in [CTF (Capture The Flag or Wargames)](https://en.wikipedia.org/wiki/Capture_the_flag_(cybersecurity)) platforms.
Learning a bit and, whith a bit of luck, solving some level or challenge.
...
In [OverTheWire](https://overthewire.org) you can learn about many topic at different levels (from 0, or almost).
...
At first I thought it wold be a waste of time. I mean, today it's trivial to break a [Vigenere Cipher](https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher). You can get the [cipher] key using offline tools or online tools like [dcode](https://www.dcode.fr/en).
...
* In [Vigenere Cipher - Decryption (Unknown Key) 11:46](https://youtu.be/LaWp_Kq0cKs?t=706) theoretically says "frecuencies of the numbers or the alphabet in order".
  Ok, but... In what order? As in his example the letters and the frecuencies are a:0.10, b:0.20 and c:0.70 all is in order. 
  The leters are in alphabetical order and the frecuencies are In increasing order...
